...
- ダッシュボードと公開管理に追加した `reservations` / `inquiries` 一覧は、2026-03-21 の実画面確認で正常でした
...
2. `Admin build: 20260321j` を確認する
3. 導線設定の左右パネル比率を微調整する
4. 必要なら `reservations` / `inquiries` の詳細画面着手範囲を整理する
...
### 次の実装候補
- `app/pages/journey.html` の左右パネル比率を微調整する
